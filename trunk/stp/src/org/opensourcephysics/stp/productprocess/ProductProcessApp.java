...
public class ProductProcessApp extends AbstractSimulation
{
	...
	public void initialize()
	{
		...
		product = 1.0;
		//double maxX=Math.pow(x, numberOfMultiplication);
		double maxX=numberOfMultiplication*Math.log(2);
		int numberOfBins= 20;
		double binWidth= maxX/numberOfBins;
...
//		control.println("sigma = 0");
	...
	public void output()
	{
		...
		control.clearMessages();
		control.println("# of runs = " + numberOfRuns);
